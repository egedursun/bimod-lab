...
from .views import Transactions_TransactionList, Transactions_AutoTopUpCreate, Transactions_AutoTopUpList, \
    Transactions_InvoiceList, Transactions_AutoTopUp_Update, Transactions_ManualTopUpCreate, \
    Transactions_BalanceTransfer
...
urlpatterns = [
    path(
        'list/',
        Transactions_TransactionList.as_view(
    ...
    path(
        'auto_top_up/create/',
        Transactions_AutoTopUpCreate.as_view(
            template_name="llm_transaction/topup/create_auto_topup.html"
        ),
        name='auto_top_up_create'
    ),
    path(
        'auto_top_up/update/<int:plan_id>/',
        Transactions_AutoTopUp_Update.as_view(
    ...
    path(
        'auto_top_up/list/',
        Transactions_AutoTopUpList.as_view(
    ...
    path(
        'transaction_invoices/list/',
        Transactions_InvoiceList.as_view(
    ...
    path(
        'top_up/create/',
        Transactions_ManualTopUpCreate.as_view(
    ...
    path(
        'top_up/transfer/',
        Transactions_BalanceTransfer.as_view(
