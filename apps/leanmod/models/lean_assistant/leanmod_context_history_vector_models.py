...
class LeanModOldChatMessagesVectorData(models.Model):
    leanmod_chat_message = models.ForeignKey(
        'multimodal_chat.MultimodalLeanChatMessage',
    ...
    def __str__(self):
        return str(
            self.leanmod_chat_message.multimodal_lean_chat.lean_assistant.id
        ) + " - " + str(
            self.leanmod_chat_message.multimodal_lean_chat.id
        ) + " - " + str(
            self.leanmod_chat_message.id
