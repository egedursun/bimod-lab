...
class CustomAPIView_Connections(LoginRequiredMixin, TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        apis = CustomAPI.objects.filter(
            created_by_user__in=users_of_conn_orgs
        )

        ext_api_refs = CustomAPIReference.objects.filter(
        ...
        context.update(
            {
                ...
                'apis': apis,
                'assistants': agents,
                'assistant_api_map': agent_api_map,
                'external_api_references_map': ext_api_refs_map
            }
        )
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            if action == 'add' and api_id:
                ...
                if ref_id:
                    reff = CustomAPIReference.objects.get(
                        id=ref_id
                    )
