...
#
#  Project: Bimod.io™
#  File: voidforger_action_memory_vector_data_models.py
#  Last Modified: 2024-11-15 15:58:48
#  Author: Ege Dogan Dursun (Co-Founder & Chief Executive Officer / CEO @ BMD™ Autonomous Holdings)
#  Created: 2024-11-15 17:08:54
#
...
from apps.voidforger.utils import OPEN_AI_DEFAULT_EMBEDDING_VECTOR_DIMENSIONS, OpenAIEmbeddingModels, \
    VECTOR_INDEX_PATH_ACTION_MEMORIES

logger = logging.getLogger(__name__)


class VoidForgerActionMemoryVectorData(models.Model):
    voidforger_action_memory = models.ForeignKey(
        'voidforger.VoidForgerActionMemoryLog',
        on_delete=models.CASCADE,
        related_name='voidforger_action_memory_vector_data'
    )
    ...
    def _generate_embedding(self, raw_data):
        ...
        c = OpenAIGPTClientManager.get_naked_client(
            llm_model=self.voidforger_action_memory.voidforger.llm_model
        )
