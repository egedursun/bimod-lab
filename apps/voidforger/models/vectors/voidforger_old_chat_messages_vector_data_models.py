...
from apps.voidforger.utils import VECTOR_INDEX_PATH_CHAT_MESSAGES, OpenAIEmbeddingModels, \
...
class VoidForgerOldChatMessagesVectorData(models.Model):
    voidforger_chat_message = models.ForeignKey('voidforger.MultimodalVoidForgerChatMessage', on_delete=models.CASCADE,
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=['voidforger_chat_message']),
    ...
    def _get_index_path(self):
        ...
        return os.path.join(VECTOR_INDEX_PATH_CHAT_MESSAGES, f'voidforger_chat_index_{voidforger_chat_id}.index')
