...
def remove_vector_from_index_on_file_system_delete(
    sender,
    instance,
    **kwargs
):
    try:
        ...
        if os.path.exists(index_path):
            ...
            logger.error(f"Index not found for DataSourceFileSystem with ID {instance.id}.")
        ...
        logger.error(f"Vector data not found for DataSourceFileSystem with ID {instance.id}.")
