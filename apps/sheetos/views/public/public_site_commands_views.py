...
#
#  Project: Bimod.io™
#  File: public_site_commands_views.py
#  Last Modified: 2024-12-09 21:26:16
#  Author: Ege Dogan Dursun (Co-Founder & Chief Executive Officer / CEO @ BMD™ Autonomous Holdings)
#  Created: 2024-12-09 21:26:17
#
...
class SheetosView_PublicGenerateViaSiteCommand(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if command is None:
            logger.error(f"Site Command is required.")

            return JsonResponse(
                {
                    "output": None,
                    "message": "Site Command is required."
                }
            )
        ...
        xc = SheetosExecutionManager_Public(
            sheetos_google_apps_connection=connection_object,
