...
#
#  Project: Bimod.io™
#  File: public_nosql_command_views.py
#  Last Modified: 2025-01-24 18:42:28
#  Author: Ege Dogan Dursun (Co-Founder & Chief Executive Officer / CEO @ BMD™ Autonomous Holdings)
#  Created: 2025-01-24 18:42:28
#
...
class BrowserExtensionView_PublicGenerateViaNoSQLCommand(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if command is None:
            ...
            return JsonResponse(
                {
                    "output": None,
                    "message": "NoSQL Command is required."
                }
            )
        ...
        response_json = xc.execute_nosql_command(
            command=command
        )
