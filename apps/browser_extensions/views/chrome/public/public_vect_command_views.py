...
#
#  Project: Bimod.io™
#  File: public_vect_command_views.py
#  Last Modified: 2025-01-24 18:43:34
#  Author: Ege Dogan Dursun (Co-Founder & Chief Executive Officer / CEO @ BMD™ Autonomous Holdings)
#  Created: 2025-01-24 18:43:34
#
...
class BrowserExtensionView_PublicGenerateViaVectCommand(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if command is None:
            ...
            return JsonResponse(
                {
                    "output": None,
                    "message": "Vect Command is required."
                }
            )
