...
#
#  Project: Bimod.io™
#  File: public_sql_command_views.py
#  Last Modified: 2025-01-24 18:41:16
#  Author: Ege Dogan Dursun (Co-Founder & Chief Executive Officer / CEO @ BMD™ Autonomous Holdings)
#  Created: 2025-01-24 18:41:17
#
...
class BrowserExtensionView_PublicGenerateViaSQLCommand(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if command is None:
            ...
            return JsonResponse(
                {
                    "output": None,
                    "message": "SQL Command is required."
                }
            )
        ...
        response_json = xc.execute_sql_command(
            command=command
        )
