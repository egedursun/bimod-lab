    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('repository', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='datasource_codebase.codebaserepository')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, to='datasource_codebase.codebaserepositorychunk'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code_base_repositories', models.ManyToManyField(blank=True, to='datasource_codebase.codebaserepository')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='knowledge_base',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='datasource_codebase.coderepositorystorageconnection'),
        ),
        migrations.AddField(
            model_name='codebaserepository',
            name='knowledge_base',
