...
def update_assistant_old_chat_messages_vector_embedding_after_save(sender, instance, created, **kwargs):
    try:
        item, success = AssistantOldChatMessagesVectorData.objects.get_or_create(assistant_chat_message=instance)
        if success:
