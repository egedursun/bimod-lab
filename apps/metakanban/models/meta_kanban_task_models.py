...
class MetaKanbanTask(models.Model):
    ...
    status_column = models.ForeignKey(
        'metakanban.MetaKanbanStatusColumn',
        on_delete=models.CASCADE
    )
    ...
    labels = models.ManyToManyField(
        'metakanban.MetaKanbanTaskLabel',
        related_name='metakanban_tasks',
        blank=True
    )
    ...
    priority = models.CharField(
        max_length=100,
        choices=META_KANBAN_TASK_PRIORITIES,
    ...
    task_image = models.ImageField(
        upload_to='metakanban/task_images/%Y/%m/%d/',
        null=True,
        blank=True
    )
    ...
    task_file = models.FileField(
        upload_to='metakanban/task_files/%Y/%m/%d/',
        null=True,
        blank=True
    )
