...
class DataSourceMLModelConnectionForm(forms.ModelForm):
    class Meta:
        ...
        fields = [
            'assistant', 'name', 'description', 'model_object_category',
            'directory_schema', 'interpretation_temperature',
        ...
        widgets = {
            ...
            'description': forms.Textarea(attrs={'class': 'form-control', 'placeholder': 'Enter data source description', 'rows': 3}),
...
class DataSourceMLModelItemForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'description': forms.Textarea(attrs={'class': 'form-control', 'placeholder': 'Enter description for the ML model', 'rows': 3}),
        }
