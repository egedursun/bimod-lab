...
def build_sheetos_action__select_prompt(user_query: str, selected_data: str):
    return f"""
        ...
        **YOUR GOAL:** The user picked the Selection Modifier Command action. You MUST check the user's query and
        understand what kind of modification they want to perform on the selected data. Then, you must modify the data user
        shared in a way to satisfy his expectations and needs. The content must be fitting the overall status of the
