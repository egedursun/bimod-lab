...
#  Last Modified: 2024-12-09 21:47:36
#  Author: Ege Dogan Dursun (Co-Founder & Chief Executive Officer / CEO @ BMD™ Autonomous Holdings)
#  Created: 2024-12-09 21:47:37
#
...
def build_sheetos_action__site_prompt(user_query: str):
    return f"""
        ...
        **YOUR GOAL:** The user picked the Website Storage Connection action. You MUST check the user's
        ...
        data, you must generate the plain CSV-formatted data in a shape and content requested by the user's query. If
        you have the information specified in your own internal knowledge, you don't need to perform a Website Data Storage
