...
#
#  Project: Bimod.io™
#  File: vect_datasource_prompt.py
#  Last Modified: 2024-10-16 01:33:30
#  Author: Ege Dogan Dursun (Co-Founder & Chief Executive Officer / CEO @ BMD™ Autonomous Holdings)
#  Created: 2024-10-16 01:33:31
#
...
def build_sheetos_vector_store_data_source_prompt(assistant: Assistant):
    ...
    response_prompt += """
            ...
            generating or modifying coherent CSV-formatted data within the spreadsheet document based on the query
            of the user. If this part is EMPTY, it means that the user has not provided any Knowledge Base
            ...
            find something relevant to the question and **NEVER** deliver your response in natural language,
