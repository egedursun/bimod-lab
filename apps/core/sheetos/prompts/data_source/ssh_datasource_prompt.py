...
#
#  Project: Bimod.io™
#  File: ssh_datasource_prompt.py
#  Last Modified: 2024-10-16 01:33:25
#  Author: Ege Dogan Dursun (Co-Founder & Chief Executive Officer / CEO @ BMD™ Autonomous Holdings)
#  Created: 2024-10-16 01:35:52
#
...
def build_sheetos_file_system_data_source_prompt(assistant: Assistant):
    ...
    response_prompt += """
            ...
            #### **NOTE**: These are the File System Connections you have access. Keep these in mind while generating
            or modifying the CSV data based on the users query. If this part is EMPTY, it means that the user has not
            provided any File System Connections (yet), so neglect this part.
