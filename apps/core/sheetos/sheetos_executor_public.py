...
class SheetosExecutionManager_Public:
    ...
    def __init__(self, sheetos_google_apps_connection: SheetosGoogleAppsConnection, text_content: str):
    ...
    def execute_ai_command(self, command: str):
        ...
        try:
            output, error = handle_ai_command_public(xc=self, command=command, content=self.content)
            logger.info(f"[SheetosExecutionManager_Public.handle_ai_command_public] AI command executed successfully: {command}")
    ...
    def execute_auto_command(self):
        ...
        try:
            ...
            logger.info(f"[SheetosExecutionManager_Public.handle_auto_command_public] AUTO command executed successfully.")
        except Exception as e:
            logger.error(f"[SheetosExecutionManager_Public.handle_auto_command_public] Error executing AUTO command. Error: {e}")
    ...
    def execute_nosql_command(self, command: str):
        ...
        response = {'output': output, 'error': output}
        try:
            output, error = handle_nosql_command_public(xc=self, command=command, content=self.content)
            logger.info(
    ...
    def execute_select_command(self, selected_data: str, command: str):
        ...
        response = {'output': output, 'error': output}
        try:
            output, error = handle_select_command_public(xc=self, selected_data=selected_data, command=command, content=self.content)
            logger.info(
    ...
    def execute_sql_command(self, command: str):
        ...
        response = {'output': output, 'error': output}
        try:
            output, error = handle_sql_command_public(xc=self, command=command, content=self.content)
            logger.info(
    ...
    def execute_ssh_command(self, command: str):
        ...
        response = {'output': output, 'error': output}
        try:
            output, error = handle_ssh_command_public(xc=self, command=command, content=self.content)
            logger.info(
    ...
    def execute_vect_command(self, command: str):
        ...
        response = {'output': output, 'error': output}
        try:
            output, error = handle_vect_command_public(xc=self, command=command, content=self.content)
            logger.info(
    ...
    def execute_web_command(self, command: str):
        ...
        response = {'output': output, 'error': output}
        try:
            output, error = handle_web_command_public(xc=self, command=command, content=self.content)
            logger.info(
    ...
    def execute_repo_command(self, command: str):
        ...
        response = {'output': output, 'error': output}
        try:
            output, error = handle_repo_command_public(xc=self, command=command, content=self.content)
            logger.info(
