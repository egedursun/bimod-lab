...
def handle_select_command_public(xc, command: str, selected_data: str, content: str) -> str:
    from apps.core.sheetos.prompt_builders import build_select_command_system_prompt_public
    ...
    system_prompt = build_select_command_system_prompt_public(xc=xc, user_query=command, selected_data=selected_data,
                                                              content=content)
    client = xc.naked_c
