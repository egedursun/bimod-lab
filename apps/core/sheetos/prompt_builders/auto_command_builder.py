...
from apps.core.sheetos.prompts import build_sheetos_agent_nickname_prompt, build_sheetos_internal_principles_prompt, \
    ...
    build_sheetos_ops_instruction_prompt, build_sheetos_action__auto_prompt, build_sheetos_action__auto_prompt_public
...
def build_auto_command_system_prompt(xc: SheetosExecutionManager):
