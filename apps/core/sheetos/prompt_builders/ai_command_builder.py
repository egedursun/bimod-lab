...
def build_ai_command_system_prompt(xc: SheetosExecutionManager, user_query: str):
    ...
    action_instructions_prompt = build_sheetos_action__ai_prompt(user_query=user_query)
...
def build_ai_command_system_prompt_public(xc, user_query: str, content: str):
