...
#
#  Project: Bimod.io™
#  File: sql_command_builder.py
#  Last Modified: 2024-10-16 01:32:00
#  Author: Ege Dogan Dursun (Co-Founder & Chief Executive Officer / CEO @ BMD™ Autonomous Holdings)
#  Created: 2024-10-16 01:32:01
#
...
from apps.core.sheetos.prompts import build_sheetos_agent_nickname_prompt, build_sheetos_internal_principles_prompt, \
    ...
    build_sheetos_ops_instruction_prompt, build_sheetos_action__sql_prompt, build_sheetos_sql_data_source_prompt, \
    build_sheetos_tool_prompt__execute_sql_query
...
def build_sql_command_system_prompt(xc: SheetosExecutionManager, user_query: str):
    ...
    action_instructions_prompt = build_sheetos_action__sql_prompt(user_query=user_query)

    data_source_prompts = build_sheetos_sql_data_source_prompt(assistant=xc.copilot)
    tool_execution_prompts = build_sheetos_tool_prompt__execute_sql_query()
...
def build_sql_command_system_prompt_public(xc: SheetosExecutionManager_Public, user_query: str, content: str):
    logger.info(f"Building SQL command system prompt for user query: {user_query}")
