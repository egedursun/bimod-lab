...
#  Last Modified: 2024-12-09 21:51:54
#  Author: Ege Dogan Dursun (Co-Founder & Chief Executive Officer / CEO @ BMD™ Autonomous Holdings)
#  Created: 2024-12-09 21:51:55
#
...
from apps.core.sheetos.prompts import (
    ...
    build_sheetos_action__site_prompt
)
...
def build_site_command_system_prompt(xc: SheetosExecutionManager, user_query: str):
    ...
    action_instructions_prompt = build_sheetos_action__site_prompt(
...
def build_site_command_system_prompt_public(
    ...
    action_instructions_prompt = build_sheetos_action__site_prompt(user_query=user_query)

    data_source_prompts = build_website_data_source_prompt(assistant=xc.copilot)
