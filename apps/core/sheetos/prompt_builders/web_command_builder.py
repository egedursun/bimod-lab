...
from apps.core.sheetos.prompts import build_sheetos_agent_nickname_prompt, build_sheetos_internal_principles_prompt, \
    ...
    build_sheetos_ops_instruction_prompt, build_sheetos_action__web_prompt, build_sheetos_browsing_data_source_prompt, \
...
def build_web_command_system_prompt(xc: SheetosExecutionManager, user_query: str):
...
def build_web_command_system_prompt_public(xc: SheetosExecutionManager_Public, user_query: str, content: str):
    logger.info(f"Building WEB command system prompt for user query: {user_query}")
