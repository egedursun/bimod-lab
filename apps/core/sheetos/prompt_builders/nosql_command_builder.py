...
from apps.core.sheetos.prompts import build_sheetos_agent_nickname_prompt, build_sheetos_internal_principles_prompt, \
    ...
    build_sheetos_ops_instruction_prompt, build_sheetos_action__nosql_prompt, build_sheetos_nosql_data_source_prompt, \
    build_sheetos_tool_prompt__execute_nosql_query
...
def build_nosql_command_system_prompt(xc: SheetosExecutionManager, user_query: str):
    ...
    action_instructions_prompt = build_sheetos_action__nosql_prompt(user_query=user_query)

    data_source_prompts = build_sheetos_nosql_data_source_prompt(assistant=xc.copilot)
    tool_execution_prompts = build_sheetos_tool_prompt__execute_nosql_query()
