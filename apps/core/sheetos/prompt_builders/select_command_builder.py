...
from apps.core.sheetos.prompts import build_sheetos_agent_nickname_prompt, build_sheetos_internal_principles_prompt, \
    ...
    build_sheetos_ops_instruction_prompt, build_sheetos_action__select_prompt
...
def build_select_command_system_prompt_public(xc: SheetosExecutionManager, user_query: str, selected_data: str,
                                              content: str):
    logger.info(f"Building SELECT command system prompt for user query: {user_query}")
    combined_system_prompt = ""
