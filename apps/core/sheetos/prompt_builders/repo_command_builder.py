...
from apps.core.sheetos.prompts import build_sheetos_agent_nickname_prompt, build_sheetos_internal_principles_prompt, \
    ...
    build_sheetos_ops_instruction_prompt, build_sheetos_action__repo_prompt, \
    build_sheetos_code_base_data_source_prompt, build_sheetos_tool_prompt__execute_codebase_query
...
def build_repo_command_system_prompt(xc: SheetosExecutionManager, user_query: str):
...
def build_repo_command_system_prompt_public(xc: SheetosExecutionManager_Public, user_query: str, content: str):
    logger.info(f"Building REPO command system prompt for user query: {user_query}")
