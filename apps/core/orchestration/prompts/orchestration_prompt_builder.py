...
from apps.core.orchestration.prompts.orchestration.build_assistant_calls_meta_tool_prompt import (
    build_orchestration_structured_tool_usage_instructions_prompt,
    build_orchestration_workers_multi_modality_prompt,
...
from apps.core.orchestration.prompts.orchestration.build_main_orchestration_prompt import (
    build_structured_orchestrator_primary_guidelines,
    build_structured_orchestrator_instructions_prompt
)
...
class OrchestrationPromptBuilder:
    ...
    def build(
        ...
        structured_instructions_prompt = build_structured_orchestrator_instructions_prompt(
            maestro=maestro
        )
        ...
        structured_audience_prompt = build_target_audience_prompt(
            audience=audience
        )

        structured_tone_prompt = build_agent_personality_prompt(
            tone=tone
        )
        ...
        structured_user_information_prompt = build_user_tenant_prompt(
            user=user
        )
        ...
        structured_workers_multi_modality_prompt = build_orchestration_workers_multi_modality_prompt(
            maestro=maestro
        )
