...
def build_slider_agent_nickname_prompt(name: str):
    return f"""
...
def build_slider_agent_personality_prompt(tone: str):
    return f"""
...
def build_slider_user_tenant_prompt(user: User):
    return f"""
        ### **USER INFORMATION:**
...
def build_slider_internal_principles_prompt():
    return f"""
            ### **PRIMARY GUIDELINES:**
...
def build_slider_spatial_awareness_prompt(user: User):
    response_prompt = """
...
def build_slider_target_audience_prompt(audience: str):
    return f"""
...
def build_slider_technical_dictionary_prompt(glossary: str):
    return f"""
