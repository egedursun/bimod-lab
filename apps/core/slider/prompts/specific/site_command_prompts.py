...
#  Last Modified: 2024-12-10 00:30:57
#  Author: Ege Dogan Dursun (Co-Founder & Chief Executive Officer / CEO @ BMD™ Autonomous Holdings)
#  Created: 2024-12-10 00:30:58
#
...
def build_slider_action__site_prompt(user_query: str):
    return f"""
        ...
        **YOUR GOAL:** The user picked the Website Storage Connection action. You MUST check the user's
        ...
        You can run any type of query on the website data vector store to get the information requested by the user.
        Then, using the information you found in the website storage, you must write the content in the form and shape
        requested by the user's query. If you have the information specified in your own internal knowledge, you don't
        need to perform a Website storage data search. But be careful in not providing false information (unless specifically
