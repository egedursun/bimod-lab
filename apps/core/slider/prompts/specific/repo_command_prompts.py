...
def build_slider_action__repo_prompt(user_query: str):
    return f"""
        ...
        **YOUR GOAL:** The user picked the Code Base Repository / Vector Store Command action. You MUST check the user's
        ...
        in the vector store, you must write the text in the form and content requested by the user's query. If you have
