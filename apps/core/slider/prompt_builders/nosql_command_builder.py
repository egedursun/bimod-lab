...
#
#  Project: Bimod.io™
#  File: nosql_command_builder.py
#  Last Modified: 2024-11-02 14:57:08
#  Author: Ege Dogan Dursun (Co-Founder & Chief Executive Officer / CEO @ BMD™ Autonomous Holdings)
#  Created: 2024-11-02 21:35:59
#
...
from apps.core.slider.prompts import build_slider_agent_nickname_prompt, build_slider_internal_principles_prompt, \
    ...
    build_slider_ops_instruction_prompt, build_slider_action__nosql_prompt, \
    build_slider_tool_prompt__execute_nosql_query, build_slider_nosql_data_source_prompt
...
def build_nosql_command_system_prompt(xc: SliderExecutionManager, user_query: str):
    ...
    action_instructions_prompt = build_slider_action__nosql_prompt(user_query=user_query)

    data_source_prompts = build_slider_nosql_data_source_prompt(assistant=xc.copilot)
    tool_execution_prompts = build_slider_tool_prompt__execute_nosql_query()
...
def build_nosql_command_system_prompt_public(xc: SliderExecutionManager_Public, user_query: str, content: str):
    logger.info(f"Building NOSQL command system prompt for user query: {user_query}")
