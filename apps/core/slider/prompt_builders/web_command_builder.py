...
from apps.core.slider.prompts import build_slider_agent_nickname_prompt, build_slider_internal_principles_prompt, \
    ...
    build_slider_ops_instruction_prompt, build_slider_action__web_prompt, build_slider_browsing_data_source_prompt, \
    build_slider_tool_prompt__browsing
...
def build_web_command_system_prompt(xc: SliderExecutionManager, user_query: str):
    ...
    action_instructions_prompt = build_slider_action__web_prompt(user_query=user_query)

    data_source_prompts = build_slider_browsing_data_source_prompt(assistant=xc.copilot)
    tool_execution_prompts = build_slider_tool_prompt__browsing()
...
def build_web_command_system_prompt_public(xc: SliderExecutionManager_Public, user_query: str, content: str):
    logger.info(f"Building WEB command system prompt for user query: {user_query}")
