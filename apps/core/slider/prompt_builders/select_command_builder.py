...
from apps.core.slider.prompts import build_slider_internal_principles_prompt, build_slider_target_audience_prompt, \
    build_slider_user_tenant_prompt, build_slider_spatial_awareness_prompt, build_slider_technical_dictionary_prompt, \
    build_slider_ops_instruction_prompt, build_slider_action__select_prompt, build_slider_agent_nickname_prompt, \
...
def build_select_command_system_prompt(xc: SliderExecutionManager, user_query: str, selected_text: str):
    ...
    action_instructions_prompt = build_slider_action__select_prompt(user_query=user_query,
...
def build_select_command_system_prompt_public(xc: SliderExecutionManager_Public, user_query: str, selected_text: str,
                                              content: str):
    logger.info(f"Building SELECT command system prompt for user query: {user_query}")
    combined_system_prompt = ""
