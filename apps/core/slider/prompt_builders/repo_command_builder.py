...
def build_repo_command_system_prompt(
    ...
    action_instructions_prompt = build_slider_action__repo_prompt(
        user_query=user_query
    )

    data_source_prompts = build_slider_code_base_data_source_prompt(
