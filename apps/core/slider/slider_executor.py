...
class SliderExecutionManager:
    ...
    def execute_ai_command(self, command: str):
        ...
        try:
            ...
            logger.error(
                f"[SliderExecutionManager.execute_ai_command] Error executing AI command: {command}. Error: {e}")
    ...
    def execute_img_command(self, command: str):
        ...
        try:
            ...
            logger.error(
                f"[SliderExecutionManager.execute_img_command] Error executing IMG command: {command}. Error: {e}")
    ...
    def execute_nosql_command(self, command: str):
        ...
        try:
            ...
            logger.info(
                f"[SliderExecutionManager.execute_nosql_command] NOSQL command executed successfully: {command}")

        except Exception as e:
            logger.error(
                f"[SliderExecutionManager.execute_nosql_command] Error executing NOSQL command: {command}. Error: {e}")
    ...
    def execute_select_command(self, selected_text: str, command: str):
        ...
        try:
            ...
            logger.info(
                f"[SliderExecutionManager.execute_select_command] SELECT command executed successfully: {command}")

        except Exception as e:
            logger.error(
                f"[SliderExecutionManager.execute_select_command] Error executing SELECT command: {command}. Error: {e}")
    ...
    def execute_sql_command(self, command: str):
        ...
        try:
            ...
            logger.error(
                f"[SliderExecutionManager.execute_sql_command] Error executing SQL command: {command}. Error: {e}")
    ...
    def execute_ssh_command(self, command: str):
        ...
        try:
            ...
            logger.error(
                f"[SliderExecutionManager.execute_ssh_command] Error executing SSH command: {command}. Error: {e}")
    ...
    def execute_vect_command(self, command: str):
        ...
        try:
            ...
            logger.error(
                f"[SliderExecutionManager.execute_vect_command] Error executing VECT command: {command}. Error: {e}")
    ...
    def execute_web_command(self, command: str):
        ...
        try:
            ...
            logger.error(
                f"[SliderExecutionManager.execute_web_command] Error executing WEB command: {command}. Error: {e}")
    ...
    def execute_repo_command(self, command: str):
        ...
        try:
            ...
            logger.error(
                f"[SliderExecutionManager.execute_repo_command] Error executing REPO command: {command}. Error: {e}")
