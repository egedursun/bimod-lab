...
def handle_nosql_command(xc, command: str) -> str:
    ...
    from apps.core.slider.prompt_builders import build_nosql_command_system_prompt
    ...
    system_prompt = build_nosql_command_system_prompt(xc=xc, user_query=command)
    client = xc.naked_c
