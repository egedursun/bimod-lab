...
def handle_img_command(xc, command: str) -> str:
    from apps.core.slider.slider_executor import SliderExecutionManager
    from apps.core.slider.prompt_builders import build_img_command_system_prompt
    ...
    system_prompt = build_img_command_system_prompt(xc=xc, user_query=command)
    client = xc.naked_c
