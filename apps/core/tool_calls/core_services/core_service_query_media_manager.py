...
def run_query_media_manager(c_id, chat_id, manager_file_type, f_uris, manager_query, no_chat=False):
    ...
    try:
        ...
        if manager_file_type == AnalysisToolCallExecutionTypesNames.FILE_INTERPRETATION:
            ...
            output = xc.interpretation_image_handler_method(full_image_paths=f_uris, query_string=manager_query)
