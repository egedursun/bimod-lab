...
def build_dashboard_statistics_prompt(statistics):
    main_instructions = f"""
        ### **INSTRUCTIONS:**
        ...
        **Important Notes:**
        ...
        sufficient for you to provide recommendations for the user.
        ...
        - You can (and expected to) come up with your own topics based on the data shared and you must delve deep
        into these topics to detect how the data can be beneficial. The topics above are shared purely as an example,
        and you don't have to answer all of these questions; since the analysis must depend on the availability and
        contextual relevance of the data. Thus, be careful about coming up with relevant and useful, beneficial topics
