...
#
#  Project: Bimod.io™
#  File: build_browser_data_source_prompt.py
    ...
    for i, browsing_datasource in enumerate(browsing_data_sources):
        response_prompt += f"""
                [Browsing Datasource ID: {browsing_datasource.id}]
                    ...
                    Description: {browsing_datasource.description or "N/A"}
...
def build_semantor_browsing_data_source_prompt(temporary_sources: dict):
    browsing_data_sources = temporary_sources.get("data_sources").get("browsers")
