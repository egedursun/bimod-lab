...
def build_sql_data_source_prompt(assistant: Assistant):
    ...
    for i, sql_data_source in enumerate(sql_data_sources):
        ...
        [SQL Data Source ID: {sql_data_source.id}]
            ...
            DB Description: {sql_data_source.description or "N/A"}
        ...
        for j, custom_query in enumerate(custom_queries_of_datasource):
            ...
            [Custom Query ID: {custom_query.id}]
                ...
                Query Description: {custom_query.description or "N/A"}
                SQL Query:
                '''
                {custom_query.sql_query or "N/A"}
                '''
            """
...
def build_semantor_sql_data_source_prompt(temporary_sources: dict):
    sql_data_sources = temporary_sources.get("data_sources").get("sql_dbs")
