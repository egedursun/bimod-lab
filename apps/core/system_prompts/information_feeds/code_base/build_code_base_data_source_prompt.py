...
#
#  Project: Bimod.io™
#  File: build_code_base_data_source_prompt.py
...
def build_semantor_code_base_data_source_prompt(temporary_sources: dict):
    code_base_data_sources = temporary_sources.get("data_sources").get("codebases")
