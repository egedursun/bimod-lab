...
#
#  Project: Bimod.io™
#  File: metakanban_boards_datasource_prompt.py
#  Last Modified: 2024-10-27 19:52:08
#  Author: Ege Dogan Dursun (Co-Founder & Chief Executive Officer / CEO @ BMD™ Autonomous Holdings)
#  Created: 2024-10-27 19:52:08
#
...
def get_board_metadata_prompt(board: MetaKanbanBoard):
    return f"""
        ...
        ***
        ...
        - **NOTE:** The board listed here is the board chosen to be managed with you as a Kanban board manager
        assistant, and to provide you more context while you are designing and manipulating the kanban and the tasks
        within the kanban board, as well as the assignee users within these tasks. This is also to help you understand
        the context of the queries delivered to your by the user in a better way. For example, if the user tells about
        a certain problem, you can use your tools to create a task for them in the Kanban board. Further information
        about this is shared in your system prompt.
    """
...
def get_board_labels_metadata_prompt(board: MetaKanbanBoard):
    ...
    return f"""
        ...
        - **NOTE:** The labels listed here are the labels that are already existing in the board. You can use this
        information to understand the current state of the board and the labels within the board. This information
        can be used to manipulate the labels of the board. Further information about this is shared in your system
        prompt.
...
def get_board_existing_tasks_metadata_prompt(board: MetaKanbanBoard):
    ...
    return f"""
        ...
        - **NOTE:** The tasks listed here are the tasks that are already existing in the columns of the board. You
        can use this information to understand the current state of the board and the tasks within the board. This
        information can be used to manipulate the tasks, assignees, and the columns of the board. This information
        can also be used to understand the context of the queries delivered to you by the user in a better way. For
        example, if the user tells about a certain problem, you can use your tools to create, update, delete a task
        for them in the Kanban board. Further information about this is shared in your system prompt.
...
def get_metakanban_last_n_action_logs_prompt(board: MetaKanbanBoard):
    ...
    return f"""
        ...
        that are recorded in the board. You can use this information to understand the recent actions taken in the
        board. This information can be used to understand the context of the queries delivered to you by the user in
        a better way. For example, if the user tells about a certain problem, you can use your tools to create, update,
        delete a task for them in the Kanban board. Further information about this is shared in your system prompt.
...
def get_metakanban_project_metadata_prompt(board: MetaKanbanBoard):
    ...
    return f"""
        ...
        **NOTE**: The project listed here is the project chosen to be managed with you as a Kanban board manager
        assistant, and to provide you more context while you are designing and manipulating the kanban and the tasks
        within the kanban board, as well as the assignee users within these tasks. This is also to help you understand
        the context of the queries delivered to your by the user in a better way. For example, if the user tells about
        a certain problem, you can use your tools to create a task for them in the Kanban board. Further information
