...
def build_drafting_folder_and_document_data_prompt(folder: DraftingFolder, doc: DraftingDocument):
    return f"""
        ...
        **NOTE**: This is the information about the folder the document you are drafting with the user belongs to.
        You need to be aware of the general meta-context instructions the folder has in order to grasp the overall
        context of other documents belonging to this folder. This will be helpful for you to draft better text
        ...
        **NOTE**: This is the information about the document you are currently drafting with the user. You must
        be careful about the tone and target audience specified for this document while creating drafted texts for
        this document. Additionally, beware of the instructions specified for this document to understand the overall
