...
def build_drafting_action__vect_prompt(user_query: str):
    return f"""
        ...
        **YOUR GOAL:** The user picked the Knowledge Base / Vector Store Command action. You MUST check the user's
        ...
        vector store, you must write the text in the form and content requested by the user's query. If you have the
