...
class DraftingExecutionManager_Public:
    ...
    def execute_site_command(self, command: str):
        ...
        try:
            ...
            logger.info(
                f"[DraftingExecutionManager.handle_site_command_public] SITE command executed successfully: {command}")

        except Exception as e:
            logger.error(
                f"[DraftingExecutionManager.handle_site_command_public] Error executing SITE command: {command}. Error: {e}")
            error = f"[DraftingExecutionManager.handle_site_command_public] Error executing SITE command: {command}. Error: {e}"
