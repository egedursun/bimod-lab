...
from apps.core.drafting.prompts import build_drafting_agent_nickname_prompt, build_drafting_internal_principles_prompt, \
    ...
    build_drafting_ops_instruction_prompt, build_drafting_action__web_prompt, \
    build_drafting_browsing_data_source_prompt, build_drafting_tool_prompt__browsing
...
def build_web_command_system_prompt(xc: DraftingExecutionManager, user_query: str):
    ...
    action_instructions_prompt = build_drafting_action__web_prompt(user_query=user_query)

    data_source_prompts = build_drafting_browsing_data_source_prompt(assistant=xc.copilot)
    tool_execution_prompts = build_drafting_tool_prompt__browsing()
...
def build_web_command_system_prompt_public(xc: DraftingExecutionManager_Public, user_query: str, content: str):
    logger.info(f"Building WEB command system prompt for user query: {user_query}")
