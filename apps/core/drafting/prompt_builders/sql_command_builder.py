...
from apps.core.drafting.prompts import build_drafting_agent_nickname_prompt, build_drafting_internal_principles_prompt, \
    ...
    build_drafting_ops_instruction_prompt, build_drafting_action__sql_prompt, build_drafting_sql_data_source_prompt, \
    build_drafting_tool_prompt__execute_sql_query
...
def build_sql_command_system_prompt(xc: DraftingExecutionManager, user_query: str):
    ...
    action_instructions_prompt = build_drafting_action__sql_prompt(user_query=user_query)

    data_source_prompts = build_drafting_sql_data_source_prompt(assistant=xc.copilot)
...
def build_sql_command_system_prompt_public(xc: DraftingExecutionManager_Public, user_query: str, content: str):
    logger.info(f"Building SQL command system prompt for user query: {user_query}")
