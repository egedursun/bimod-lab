...
from apps.core.drafting.prompts import build_drafting_agent_nickname_prompt, build_drafting_internal_principles_prompt, \
    ...
    build_drafting_action__auto_prompt, build_drafting_action__auto_prompt_public
...
def build_auto_command_system_prompt_public(xc: DraftingExecutionManager, content: str):
    ...
    drafting_ops_instruction_prompt = build_drafting_ops_instruction_prompt()
    action_instructions_prompt = build_drafting_action__auto_prompt_public(content=content)
