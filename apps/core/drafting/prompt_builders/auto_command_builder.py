...
#  Last Modified: 2024-10-16 01:31:30
#  Author: Ege Dogan Dursun (Co-Founder & Chief Executive Officer / CEO @ BMD™ Autonomous Holdings)
#  Created: 2024-10-16 01:31:31
#
...
from apps.core.drafting.prompts import build_drafting_agent_nickname_prompt, build_drafting_internal_principles_prompt, \
    ...
    build_drafting_technical_dictionary_prompt, build_drafting_ops_instruction_prompt, \
    build_drafting_action__auto_prompt
...
def build_auto_command_system_prompt(xc: DraftingExecutionManager):
    ...
    action_instructions_prompt = build_drafting_action__auto_prompt(xc=xc)

    # For data source operations: data source prompts must be added
    # For data source operations: generic tool prompts must be added
    # For data source operations: specific execution prompts must be added
