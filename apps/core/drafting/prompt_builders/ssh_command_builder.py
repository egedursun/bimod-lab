...
#  Last Modified: 2024-10-16 01:32:07
#  Author: Ege Dogan Dursun (Co-Founder & Chief Executive Officer / CEO @ BMD™ Autonomous Holdings)
#  Created: 2024-10-16 01:32:08
#
...
from apps.core.drafting.prompts import build_drafting_agent_nickname_prompt, build_drafting_internal_principles_prompt, \
    ...
    build_drafting_ops_instruction_prompt, build_drafting_action__ssh_prompt, \
    build_drafting_file_system_data_source_prompt, build_drafting_tool_prompt__execute_ssh_file_system_command
...
def build_ssh_command_system_prompt(xc: DraftingExecutionManager, user_query: str):
    ...
    action_instructions_prompt = build_drafting_action__ssh_prompt(user_query=user_query)

    data_source_prompts = build_drafting_file_system_data_source_prompt(assistant=xc.copilot)
...
def build_ssh_command_system_prompt_public(xc: DraftingExecutionManager_Public, user_query: str, content: str):
    logger.info(f"Building SSH command system prompt for user query: {user_query}")
