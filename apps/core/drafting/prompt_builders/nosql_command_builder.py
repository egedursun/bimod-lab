...
#  Last Modified: 2024-10-16 01:31:45
#  Author: Ege Dogan Dursun (Co-Founder & Chief Executive Officer / CEO @ BMD™ Autonomous Holdings)
#  Created: 2024-10-16 01:31:45
#
...
from apps.core.drafting.prompts import build_drafting_agent_nickname_prompt, build_drafting_internal_principles_prompt, \
    ...
    build_drafting_ops_instruction_prompt, build_drafting_nosql_data_source_prompt, \
    build_drafting_action__nosql_prompt, build_drafting_tool_prompt__execute_nosql_query
...
def build_nosql_command_system_prompt(xc: DraftingExecutionManager, user_query: str):
    ...
    action_instructions_prompt = build_drafting_action__nosql_prompt(user_query=user_query)

    data_source_prompts = build_drafting_nosql_data_source_prompt(assistant=xc.copilot)
...
def build_nosql_command_system_prompt_public(xc: DraftingExecutionManager_Public, user_query: str, content: str):
    logger.info(f"Building NOSQL command system prompt for user query: {user_query}")
