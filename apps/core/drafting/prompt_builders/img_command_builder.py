...
#  Last Modified: 2024-10-16 01:31:39
#  Author: Ege Dogan Dursun (Co-Founder & Chief Executive Officer / CEO @ BMD™ Autonomous Holdings)
#  Created: 2024-10-16 01:31:39
#
...
def build_img_command_system_prompt(xc: DraftingExecutionManager, user_query: str):
    ...
    action_instructions_prompt = build_drafting_action__img_prompt(user_query=user_query)
...
def build_img_command_system_prompt_public(xc: DraftingExecutionManager_Public, user_query: str, content: str):
    logger.info(f"Building IMG command system prompt for user query: {user_query}")
