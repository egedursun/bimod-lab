...
class BrowsingExecutor:
    ...
    def browser_search(
        ...
        print("Page Data Raw: ", self.d.page_source)
    ...
    def get_page(
        ...
        try:
            self.d.get(url)
            print(f"Opened the URL: {url} on browsing driver.")
    ...
    def get_title(self):
        ...
        try:
            print(f"Getting the title of the page.")
            return self.d.title
    ...
    def get_page_content(self):
        ...
        try:
            ...
            print(f"Getting the content of the page.")
    ...
    def get_search_results(self):
        ...
        try:
            ...
            print(f"Getting the search results.")
        ...
        try:
            ...
            print(f"Search results: {clean_results}")
    ...
    def find(
        ...
        try:
            ...
            print(f"Finding the element on browsing.")
    ...
    def send_keys(
        ...
        try:
            ...
            print(f"Sending keys to the element on browsing.")
        ...
        try:
            for r in search_results:
                ...
                if r["url"] == click_url:
                    ...
                    print(f"Clicked the URL: {click_url} in the search results.")
    ...
    def click(
        ...
        try:
            ...
            print(f"Clicked the element on browsing.")
    ...
    def filter_on_whitelist(
        ...
        print(f"Filtered results on whitelist: {filtered_results}")
    ...
    def filter_on_blacklist(
        ...
        print(f"Filtered results on blacklist: {filtered_results}")
        return filtered_results

    @staticmethod
    def get_cleaned_search_results(
        raw_selenium_results
    ):
        ...
        print(f"Cleaned search results: {cleaned_results}")
    ...
    def clean_page_content(
        ...
        try:
            ...
            print(f"Cleaned the page content.")
