...
def build_repo_command_system_prompt_public(xc: FormicaExecutionManager_Public, user_query: str, content: str):
    ...
    action_instructions_prompt = build_formica_action__repo_prompt(user_query=user_query)

    data_source_prompts = build_formica_code_base_data_source_prompt(assistant=xc.copilot)
    tool_execution_prompts = build_formica_tool_prompt__execute_codebase_query()
