...
#
#  Project: Bimod.io™
#  File: img_command_builder.py
#  Last Modified: 2024-10-31 05:36:06
#  Author: Ege Dogan Dursun (Co-Founder & Chief Executive Officer / CEO @ BMD™ Autonomous Holdings)
#  Created: 2024-11-02 13:39:41
#
...
from apps.core.formica.prompts import build_formica_agent_nickname_prompt, build_formica_internal_principles_prompt, \
    ...
    build_formica_technical_dictionary_prompt, build_formica_ops_instruction_prompt, build_formica_action__img_prompt, \
    build_formica_tool_prompt__generate_image, build_formica_spatial_awareness_prompt
from apps.core.formica.prompts.formica.whole_text_supplier_prompt import build_whole_text_supply_prompt_public

logger = logging.getLogger(__name__)


def build_img_command_system_prompt_public(xc: FormicaExecutionManager_Public, user_query: str, content: str):
    ...
    action_instructions_prompt = build_formica_action__img_prompt(user_query=user_query)
