...
from apps.core.formica.prompts import build_formica_agent_nickname_prompt, build_formica_internal_principles_prompt, \
    ...
    build_formica_ops_instruction_prompt, build_formica_action__web_prompt, build_formica_browsing_data_source_prompt, \
...
def build_web_command_system_prompt_public(xc: FormicaExecutionManager_Public, user_query: str, content: str):
    ...
    action_instructions_prompt = build_formica_action__web_prompt(user_query=user_query)

    data_source_prompts = build_formica_browsing_data_source_prompt(assistant=xc.copilot)
