...
from apps.core.formica.prompts import build_formica_agent_nickname_prompt, build_formica_internal_principles_prompt, \
    ...
    build_formica_ops_instruction_prompt, build_formica_action__auto_prompt_public
from apps.core.formica.prompts.formica.whole_text_supplier_prompt import build_whole_text_supply_prompt_public

logger = logging.getLogger(__name__)


def build_auto_command_system_prompt_public(xc: FormicaExecutionManager_Public, content: str):
    ...
    action_instructions_prompt = build_formica_action__auto_prompt_public(content=content)
