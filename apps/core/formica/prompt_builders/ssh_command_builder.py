...
from apps.core.formica.prompts import build_formica_agent_nickname_prompt, build_formica_internal_principles_prompt, \
    ...
    build_formica_ops_instruction_prompt, build_formica_action__ssh_prompt, \
    build_formica_file_system_data_source_prompt, build_formica_tool_prompt__execute_ssh_file_system_command
from apps.core.formica.prompts.formica.whole_text_supplier_prompt import build_whole_text_supply_prompt_public

logger = logging.getLogger(__name__)


def build_ssh_command_system_prompt_public(xc: FormicaExecutionManager_Public, user_query: str, content: str):
    ...
    action_instructions_prompt = build_formica_action__ssh_prompt(user_query=user_query)

    data_source_prompts = build_formica_file_system_data_source_prompt(assistant=xc.copilot)
