...
from apps.core.formica.prompts import build_formica_agent_nickname_prompt, build_formica_internal_principles_prompt, \
    ...
    build_formica_ops_instruction_prompt, build_formica_action__sql_prompt, build_formica_sql_data_source_prompt, \
    build_formica_tool_prompt__execute_sql_query
from apps.core.formica.prompts.formica.whole_text_supplier_prompt import build_whole_text_supply_prompt_public

logger = logging.getLogger(__name__)


def build_sql_command_system_prompt_public(xc: FormicaExecutionManager_Public, user_query: str, content: str):
    ...
    action_instructions_prompt = build_formica_action__sql_prompt(user_query=user_query)

    data_source_prompts = build_formica_sql_data_source_prompt(assistant=xc.copilot)
    tool_execution_prompts = build_formica_tool_prompt__execute_sql_query()
