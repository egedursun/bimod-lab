...
from apps.core.formica.utils import find_tool_call_from_json, FORMICA_TOOL_CALL_MAXIMUM_ATTEMPTS
...
def handle_vect_command_public(xc, command: str, content: str) -> str:
    from apps.core.formica.formica_executor_public import FormicaExecutionManager_Public
    from apps.core.formica.prompt_builders import build_vect_command_system_prompt_public
    ...
    system_prompt = build_vect_command_system_prompt_public(xc=xc, user_query=command, content=content)
    client = xc.naked_c
