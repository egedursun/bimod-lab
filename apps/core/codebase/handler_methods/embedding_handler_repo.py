...
def build_repository_orm_structure(
    document: dict,
    knowledge_base,
    path: str
):
...
def build_repository_weaviate_structure(
    document: dict,
    path: str,
    ...
    try:
        ...
        document_weaviate_object = {
            ...
            "repository_metadata": weaviate_document_metadata,
...
def embed_repository_sync(
    ...
    try:
        ...
        try:
            ...
            logger.error(
                f"[repository_embedder.embed_repository_sync] Error saving the repository ORM object into DB: {e}")
