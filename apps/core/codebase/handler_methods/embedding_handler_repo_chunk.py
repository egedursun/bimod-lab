...
def build_chunk_orm_structure(chunk: dict,
    ...
    try:
        ...
        chunk_orm_object = CodeBaseRepositoryChunk.objects.create(
            knowledge_base=chunk_knowledge_base, chunk_number=chunk_number, chunk_content=chunk_content,
    ...
    try:
        for i, chunk in enumerate(chunks):
            chunk_id, error = build_chunk_orm_structure(
                knowledge_base=conn_orm_obj, chunk=chunk, path=path, chunk_index=i, document_id=document_id,
