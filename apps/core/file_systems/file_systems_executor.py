...
class FileSystemsExecutor:
    ...
    def execute_file_system_command_set(self, commands: list[str]):
        ...
        client = self.connect_c()
        results = {"status": True, "stdins": [], "stdouts": [], "stderrs": [],
                   "schema_before_execution": self.schema_str, "updated_schema": ""}
        ...
        try:
            tx = LLMTransaction(
                ...
                encoding_engine=GPT_DEFAULT_ENCODING_ENGINE, llm_cost=InternalServiceCosts.FileSystemsExecutor.COST,
                transaction_type=ChatRoles.SYSTEM,
                transaction_source=LLMTransactionSourcesTypesNames.FILE_SYSTEM_COMMANDS, is_tool_cost=True)
            tx.save()
