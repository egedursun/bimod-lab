...
class AuxiliaryLLMVisualClient:
    ...
    def generate_image(self, prompt: str, image_size: str, quality: str):
        ...
        try:
            gen_img_output = self.connection.images.generate(
                model=gen_img_llm_model, prompt=prompt, size=image_size, quality=quality, n=DEFAULT_IMAGE_GENERATION_N)
    ...
    def edit_image(self, prompt: str, edit_image_uri: str, edit_image_mask_uri: str, image_size: str):
        ...
        try:
            ...
            llm_output = self.connection.images.edit(
                model=edit_img_llm_model, image=edit_img_bytes, mask=mask_img_bytes,
    ...
    def dream_image(self, image_uri: str, image_size: str):
        final_output = {"success": False, "message": "", "image_url": ""}
        ...
        try:
            ...
            output = self.connection.images.create_variation(
                model=dream_img_llm_model, image=img_bytes, n=DEFAULT_IMAGE_VARIATION_N, size=image_size)
