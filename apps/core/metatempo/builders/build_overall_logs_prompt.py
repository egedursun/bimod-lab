...
#
from apps.core.metatempo.prompts import get_generic_overall_log_prompt, get_daily_logs_datasource_prompt, \
...
def build_overall_interpretation_prompt(connection: MetaTempoConnection, batched_logs: list):
    ...
    merged_prompt += get_daily_logs_datasource_prompt(connection=connection, batched_logs=batched_logs)
