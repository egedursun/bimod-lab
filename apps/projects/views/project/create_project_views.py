...
class ProjectsView_ProjectCreate(LoginRequiredMixin, TemplateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        ##############################
        # PERMISSION CHECK FOR - ADD_PROJECTS
        if not UserPermissionManager.is_authorized(
            user=self.request.user,
            operation=PermissionNames.ADD_PROJECTS
        ):
            messages.error(self.request, "You do not have permission to add projects.")
