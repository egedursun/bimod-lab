...
def load_pdf_content(path: str):
    ...
    if performance_length__pypdfloader > performance_length__pdfplumber and performance_length__pypdfloader > performance_length__pymupdf:
        print("/ PyPDFLoader has the best performance.")
        clean_doc = clean_doc__pypdfloader
    elif performance_length__pdfplumber > performance_length__pypdfloader and performance_length__pdfplumber > performance_length__pymupdf:
        print("/ PDFPlumber has the best performance.")
        clean_doc = clean_doc__pdfplumber
    elif performance_length__pymupdf > performance_length__pypdfloader and performance_length__pymupdf > performance_length__pdfplumber:
...
"""
# Test the loading function with a specified PDF path
if __name__ == "__main__":
    loaded_content = load_pdf_content("./namtek.pdf")
    print("=========")
    print(loaded_content["page_content"])
    print("=========")
    logger.info(f"[tasks.load_pdf_content] PDF content loaded successfully.")
"""
