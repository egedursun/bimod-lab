...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='context_history_memories', to='datasource_knowledge_base.contexthistoryknowledgebaseconnection'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='contexthistorymemorychunk',
            name='memory',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='memory_chunks', to='datasource_knowledge_base.contexthistorymemory'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='knowledge_base',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='knowledge_base_documents', to='datasource_knowledge_base.documentknowledgebaseconnection'),
        ),
        migrations.AddField(
