...
def update_leanmod_assistant_embedding_after_save(sender, instance, created, **kwargs):
    try:
        item, success = LeanModVectorData.objects.get_or_create(leanmod_assistant=instance)
        if success:
