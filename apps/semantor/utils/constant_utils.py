...
VECTOR_INDEX_PATH_ASSISTANTS = os.path.join(
    BASE_DIR,
    'vectors',
    'semantor_vectors',
    'assistants'
...
VECTOR_INDEX_PATH_LEANMOD_ASSISTANTS = os.path.join(
    BASE_DIR,
    'vectors',
    'semantor_vectors',
    'leanmod_assistants'
...
VECTOR_INDEX_PATH_INTEGRATIONS = os.path.join(
    BASE_DIR,
    'vectors',
    'semantor_vectors',
    'integrations'
