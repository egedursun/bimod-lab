...
def execute_file_system_commands(connection_id: int, commands: list[str]):
    ...
    print(f"[file_system_command_execution_handler.execute_file_system_commands] Executing file system commands: {commands}.")
    try:
        ...
        error = f"[file_system_command_execution_handler.execute_file_system_commands] Error occurred while executing the file system commands: {str(e)}"
        return error
    print(f"[file_system_command_execution_handler.execute_file_system_commands] File system commands executed successfully.")
