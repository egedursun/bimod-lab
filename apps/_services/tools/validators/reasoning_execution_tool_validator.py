...
#
#  Project: Br6.in™
#  File: reasoning_execution_tool_validator.py
#  Last Modified: 2024-10-06 20:35:56
#  Author: Ege Dogan Dursun (Co-Founder & Chief Executive Officer / CEO @ BMD™ Autonomous Holdings)
#  Created: 2024-10-06 20:35:57
#
...
def validate_reasoning_execution_tool_json(tool_usage_json: dict):
    ...
    if "query" not in parameters:
        return """
            ...
            using the Reasoning Process Execution tool. Please make sure you are defining the 'query' field in the
            parameters field of the tool_usage_json.
        """
    print(
        f"[reasoning_execution_tool_validator.validate_reasoning_execution_tool_json] Validation is successful.")
    return None
