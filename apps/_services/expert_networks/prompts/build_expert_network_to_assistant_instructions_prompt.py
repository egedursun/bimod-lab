    ...
    return f"""
        **WARNING: This is an automated message.**
            ...
            *IMPORTANT*: PLEASE READ FOLLOWING NOTE CAREFULLY !
            ...
            that are not essential to complete the task. Only ask questions about blockers preventing you from completing,
            and wait for orchestrator to respond with info.
