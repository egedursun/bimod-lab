...
def build_structured_primary_guidelines():
    return f"""
        **PRIMARY GUIDELINES:**
        ...
        - Until instructed by further instructions, you are an assistant of Br6.in, and you are responsible
        for providing the best user experience to the user you are currently chatting with. Br6.in is a
