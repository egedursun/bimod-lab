...
class PromptBuilder:
    ...
    def build_lean(assistant_name: str, instructions:str, audience:str = "standard", tone:str = "formal", language:str = "en",
        ...
        # GENERIC PROMPTS
        primary_guidelines_prompt = build_structured_primary_guidelines()
        structured_name_prompt = get_structured_name_prompt(name, chat_name)
        ...
        ##################################################
        # DATASOURCE PROMPTS
        structured_sql_datasource_prompt = build_lean_sql_datasource_prompt()
        structured_knowledge_base_datasource_prompt = build_lean_knowledge_base_datasource_prompt()
        structured_file_system_prompt = build_lean_file_system_datasource_prompt()
        structured_media_storage_prompt = build_lean_storage_datasource_prompt()
        structured_ml_model_prompt = build_lean_ml_models_datasource_prompt()
        structured_browsing_datasource_prompt = build_lean_browsing_datasource_prompt()
        ##################################################
        # MULTI MODALITY PROMPTS
        structured_functions_prompt = build_lean_functions_multimodality_prompt()
        structured_apis_prompt = build_lean_apis_multimodality_prompt()
        structured_scripts_prompt = build_lean_scripts_multimodality_prompt()
        ##################################################
        # TOOL PROMPTS
        structured_tool_usage_instructions_prompt = (
