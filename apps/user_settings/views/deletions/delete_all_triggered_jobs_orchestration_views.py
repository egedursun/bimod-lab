...
class SettingsView_DeleteAllOrchestrationTriggeredJobs(View, LoginRequiredMixin):
    ...
    def post(self, request, *args, **kwargs):
        user = request.user
        user_orchestration_triggered_jobs = OrchestrationTriggeredJob.objects.filter(trigger_maestro__organization__users__in=[user]).all()
        ...
        try:
            ...
            messages.success(request, "All Orchestration triggered jobs associated with your account have been deleted.")
