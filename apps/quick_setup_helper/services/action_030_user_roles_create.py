...
from apps.quick_setup_helper.utils import (
    UserRoleQuickIntegrationChoicesNames
)
...
from apps.user_permissions.utils import (
    PredefinedRolePackages__Functional,
...
def action__030_user_roles_create(
    ...
    try:
        ...
        for selected_rol_name in selected_roles:
            ...
            role_permissions = get_boilerplate_role_permissions(
                boilerplate_role_name=selected_rol_name
            )
        ...
        for invited_new_user in metadata__invited_new_users:
            ...
            try:
                ...
                for new_user_role in new_user_roles:
                    ...
                    success_add_permissions = update_user_permissions(
                        user=invited_new_user,
                        role=new_user_role
                    )
...
def get_boilerplate_role_permissions(
    boilerplate_role_name: str
):
...
def update_user_permissions(
    ...
    try:
        for perm_code in role.role_permissions:
            try:
                _, _ = UserPermission.objects.get_or_create(
                    user=user,
