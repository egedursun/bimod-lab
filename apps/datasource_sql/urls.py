...
from apps.datasource_sql.views import (
    SQLDatabaseView_ManagerCreate,
    SQLDatabaseView_ManagerList,
    SQLDatabaseView_QueryCreate,
    SQLDatabaseView_ManagerUpdate,
...
urlpatterns = [
    path(
        "create/",
        SQLDatabaseView_ManagerCreate.as_view(
    ...
    path(
        "list/",
        SQLDatabaseView_ManagerList.as_view(
    ...
    path(
        "update/<int:pk>/",
        SQLDatabaseView_ManagerUpdate.as_view(
    ...
    path(
        "delete/<int:pk>/",
        SQLDatabaseView_ManagerDelete.as_view(
    ...
    path(
        "create_query/",
        SQLDatabaseView_QueryCreate.as_view(
    ...
    path(
        "list_queries/",
        SQLDatabaseView_QueryList.as_view(
    ...
    path(
        "update_query/<int:pk>/",
        SQLDatabaseView_QueryUpdate.as_view(
    ...
    path(
        "delete_query/<int:pk>/",
        SQLDatabaseView_QueryDelete.as_view(
