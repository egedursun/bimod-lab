...
class AuxiliaryInformationFeedsManager:
    ...
    @staticmethod
    def calculate_total_sql_read_queries_per_assistants(
        agents,
        txs,
        n_days
    ):
    ...
    @staticmethod
    def calculate_total_sql_write_queries_per_assistants(
        agents,
        txs,
        n_days
    ):
    ...
    @staticmethod
    def calculate_total_sql_queries_per_assistants(
        agents,
        txs,
        n_days
    ):
    ...
    @staticmethod
    def calculate_total_nosql_read_queries_per_assistants(
        agents,
        txs,
        n_days
    ):
    ...
    @staticmethod
    def calculate_total_nosql_write_queries_per_assistants(
        agents,
        txs,
        n_days
    ):
    ...
    @staticmethod
    def calculate_total_nosql_queries_per_assistants(
        agents,
        txs,
        n_days
    ):
    ...
    @staticmethod
    def calculate_total_ssh_file_system_access_per_assistants(
        agents,
        txs,
        n_days
    ):
    ...
    @staticmethod
    def calculate_total_web_queries_per_assistants(
        agents,
        txs,
        n_days
    ):
