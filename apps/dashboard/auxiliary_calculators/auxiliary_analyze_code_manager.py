...
class AuxiliaryAnalyzeCodeManager:
    @staticmethod
    def calculate_total_document_interpretations_per_assistants(
        agents,
        txs,
        n_days
    ):
    ...
    @staticmethod
    def calculate_total_code_interpretations_per_assistants(
        agents,
        txs,
        n_days
    ):
    ...
    @staticmethod
    def calculate_total_image_interpretations_per_assistants(
        agents,
        txs,
        n_days
    ):
