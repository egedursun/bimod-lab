...
class HadronPrimeView_DetailHadronNode(LoginRequiredMixin, TemplateView):
    def get_context_data(self, **kwargs):
        ...
        context['speech_logs_page_obj'] = paginator_speech_logs.get_page(
            page_number_speech_logs
        )
        ...
        context['execution_logs_page_obj'] = paginator_exec_logs.get_page(
            page_number_exec_logs
        )
        ...
        context['seas_logs_page_obj'] = paginator_seas_logs.get_page(
            page_number_seas_logs
        )
        ...
        context['publishing_logs_page_obj'] = paginator_topic_logs.get_page(
            page_number_topic_logs
        )
