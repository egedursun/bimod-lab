...
class HadronNode(models.Model):
    ...
    action_set_curl = models.TextField(null=True, blank=True)  # needs to be dynamically retrieved
    ...
    activation_trigger_endpoint = models.CharField(null=True, blank=True)
