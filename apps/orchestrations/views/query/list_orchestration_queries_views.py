        ...
        query_log = OrchestrationQueryLog.objects.create(
            ...
            log_text_content=query_text + f"""
                        ...
                        **FILE URLS:**
                        ...
                        -----
                    """,
            log_file_contents=attached_images,
            log_image_contents=attached_files
        )
