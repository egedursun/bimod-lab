...
from apps.data_security.views import (
    NERView_IntegrationCreate,
    NERView_IntegrationUpdate,
    NERView_IntegrationDelete,
...
urlpatterns = [
    path(
        "ner/create/",
        NERView_IntegrationCreate.as_view(
    ...
    path(
        "ner/list/",
        NERView_IntegrationList.as_view(
    ...
    path(
        "ner/update/<int:pk>/",
        NERView_IntegrationUpdate.as_view(
    ...
    path(
        "ner/delete/<int:pk>/",
        NERView_IntegrationDelete.as_view(
