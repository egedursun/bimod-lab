...
contract VestingEscrow {
    ...
    constructor(IERC20 _token, address _beneficiary, address _escrow, uint256 _startTime, uint256 _duration, uint256 _totalTokens) {
        token = _token;
    ...
    function release() public {
        ...
        token.transferFrom(escrow, beneficiary, unreleased);
    }
