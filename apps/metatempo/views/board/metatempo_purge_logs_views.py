...
class MetaTempoView_PurgeLogs(LoginRequiredMixin, View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            messages.error(
                request,
                f"Failed to purge logs for the selected MetaTempo connection. Error: {str(e)}"
            )
        ...
        messages.success(
            request,
            f"All logs for the selected MetaTempo connection have been purged successfully."
        )
