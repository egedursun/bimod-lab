...
MAX_ML_STORAGES_PER_ASSISTANT = int(os.environ.get("MAX_ML_STORAGES_PER_ASSISTANT", default="3"))
MAX_ML_MODELS_PER_STORAGE = int(os.environ.get("MAX_ML_MODELS_PER_STORAGE", default="5"))
MAX_NOSQL_DBS_PER_ASSISTANT = int(os.environ.get("MAX_NOSQL_DBS_PER_ASSISTANT", default="3"))
MAX_NOSQL_QUERIES_PER_DB = int(os.environ.get("MAX_NOSQL_QUERIES_PER_DB", default="5"))
MAX_SQL_DBS_PER_ASSISTANT = int(os.environ.get("MAX_SQL_DBS_PER_ASSISTANT", default="3"))
MAX_SQL_QUERIES_PER_DB = int(os.environ.get("MAX_SQL_QUERIES_PER_DB", default="5"))
MAX_VIDEO_GENERATORS_PER_ASSISTANT = int(os.environ.get("MAX_VIDEO_GENERATORS_PER_ASSISTANT", default="3"))
MAX_PROJECTS_PER_ASSISTANT = int(os.environ.get("MAX_PROJECTS_PER_ASSISTANT", default="3"))
MAX_TEAMS_PER_PROJECT = int(os.environ.get("MAX_TEAMS_PER_PROJECT", default="5"))

MAX_FUNCTIONS_PER_ASSISTANT = int(os.environ.get("MAX_FUNCTIONS_PER_ASSISTANT", default="3"))
MAX_APIS_PER_ASSISTANT = int(os.environ.get("MAX_APIS_PER_ASSISTANT", default="3"))
MAX_SCRIPTS_PER_ASSISTANT = int(os.environ.get("MAX_SCRIPTS_PER_ASSISTANT", default="3"))

MAX_SCHEDULED_JOBS_PER_ASSISTANT = int(os.environ.get("MAX_SCHEDULED_JOBS_PER_ASSISTANT", default="3"))
MAX_SCHEDULED_JOBS_PER_LEANMOD = int(os.environ.get("MAX_SCHEDULED_JOBS_PER_LEANMOD", default="3"))
MAX_SCHEDULED_JOBS_PER_MAESTRO = int(os.environ.get("MAX_SCHEDULED_JOBS_PER_MAESTRO", default="3"))
MAX_TRIGGERED_JOBS_PER_ASSISTANT = int(os.environ.get("MAX_TRIGGERED_JOBS_PER_ASSISTANT", default="3"))
MAX_TRIGGERED_JOBS_PER_LEANMOD = int(os.environ.get("MAX_TRIGGERED_JOBS_PER_LEANMOD", default="3"))
MAX_TRIGGERED_JOBS_PER_MAESTRO = int(os.environ.get("MAX_TRIGGERED_JOBS_PER_MAESTRO", default="3"))
