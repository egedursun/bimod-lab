...
from apps.notifications.utils import (
    ...
    NotificationFAIconChoicesNames,
    ...
    def post(self, request):
        ...
        try:
            ...
            messages.error(request,
                           "Invalid date format detected, please fix your birthdate manually on your profile.")
        ...
        user_profile.free_credits = settings.NEW_USER_FREE_CREDITS if hasattr(
            settings,
