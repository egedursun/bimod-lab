...
def send_announcement_email(
    ...
    context = {
        'ANNOUNCEMENT_TITLE': title_raw,
        'ANNOUNCEMENT_BODY': body_raw
    }
    ...
    file_path = os.path.join(
        ...
        '..',
        'helper_templates',
        'announcement_email_template.html'
    )
...
def send_accreditation_approval_email(email):
    ...
    try:
        file_path = os.path.join(
            ...
            '..',
            'helper_templates',
            'account_approved_email_template.html'
        )
...
def send_invitation_email(email, token):
    ...
    set_password_url = get_absolute_url(
        reverse(
            'reset-password',
            kwargs={
                'token': token
    ...
    context = {
        'VERIFICATION_LINK': set_password_url
    }
